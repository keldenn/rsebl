        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/listedscripts">
            <motion.div whileHover={{ scale: 1, rotate: 2 }} whileTap={{ scale: 0.95 }} className="p-6 rounded-xl border bg-card dark:bg-dark-card text-card-foreground dark:text-dark-card-foreground flex flex-col items-center transition group hover:bg-gradient-to-br hover:from-[#9D70FF] hover:to-[#25295F] hover:text-white">
              <FiFileText className="w-12 h-12 text-indigo-600 mb-4 group-hover:text-white transition-colors" />
              <p className="text-4xl font-extrabold text-gray-800 dark:text-white group-hover:text-white transition-colors">18</p>
              <motion.div className="w-16 h-1 bg-indigo-600 group-hover:bg-white mt-2 mb-4" animate={{ width: ["0%", "100%"], transition: { duration: 0.4 } }}></motion.div>
          ...
          <Link href="/brokeragefirms">
            <motion.div whileHover={{ scale: 1, rotate: 2 }} whileTap={{ scale: 0.95 }} className="p-6 rounded-xl border bg-card dark:bg-dark-card text-card-foreground dark:text-dark-card-foreground flex flex-col items-center transition group hover:bg-gradient-to-br hover:from-[#9D70FF] hover:to-[#25295F] hover:text-white">
              <FiBriefcase className="w-12 h-12 text-indigo-600 mb-4 group-hover:text-white transition-colors" />
          ...
          <Link href="/bsi">
            <motion.div whileHover={{ scale: 1, rotate: 2 }} whileTap={{ scale: 0.95 }} className="p-6 rounded-xl border bg-card dark:bg-dark-card text-card-foreground dark:text-dark-card-foreground flex flex-col items-center transition group hover:bg-gradient-to-br hover:from-[#9D70FF] hover:to-[#25295F] hover:text-white">
              <FiBarChart2 className="w-12 h-12 text-indigo-600 mb-4 group-hover:text-white transition-colors" />
          ...
          <Link href="/marketcap">
            <motion.div whileHover={{ scale: 1, rotate: 2 }} whileTap={{ scale: 0.95 }} className="p-6 rounded-xl border bg-card dark:bg-dark-card text-card-foreground dark:text-dark-card-foreground flex flex-col items-center transition group hover:bg-gradient-to-br hover:from-[#9D70FF] hover:to-[#25295F] hover:text-white">
              <FiTrendingUp className="w-12 h-12 text-indigo-600 mb-4 group-hover:text-white transition-colors" />
